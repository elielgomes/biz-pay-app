			...
			<Dialog open={open} onOpenChange={onOpenChange}>
				<DialogContent className="max-w-screen-lg max-h-screen px-0">
					<ScrollArea className="max-h-[calc(100vh-100px)] px-4">
						<DialogHeader>
							<DialogTitle>Recibo de pagamento de salário</DialogTitle>
						</DialogHeader>
							...
							<Table className="w-full">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell className="text-right">{payslip?.bonus}</TableCell>
										<TableCell className="text-right"></TableCell>
									</TableRow>
									...
									<TableRow>
										...
										<TableCell className="text-right"></TableCell>
										<TableCell className="text-right">{payslip?.discounts}</TableCell>
									</TableRow>

									<TableRow>
										<TableCell className="font-medium">INSS</TableCell>
										<TableCell className="text-right"></TableCell>
										<TableCell className="text-right">{payslip?.inss}</TableCell>
									</TableRow>

									<TableRow>
										<TableCell className="font-medium">IRRF</TableCell>
										<TableCell className="text-right"></TableCell>
										<TableCell className="text-right">{payslip?.irrf}</TableCell>
									</TableRow>
								...
								<TableFooter className="bg-white">
									...
									<TableRow className="bg-slate-50 text-black hover:bg-slate-100">
										...
										<TableCell className="text-right">{payslip && payslip.grossSalary + payslip.bonus}</TableCell>
										<TableCell className="text-right">{payslip && payslip.discounts + payslip.inss + payslip.irrf}</TableCell>
									</TableRow>

									<TableRow className="bg-slate-200 text-black hover:bg-slate-200">
										<TableCell></TableCell>
										<TableCell className="text-right">Salário líquido</TableCell>
										<TableCell className="text-right font-bold">R$ {payslip && payslip.netSalary}</TableCell>
									</TableRow>
